...
def main():
    ...
    df_combined_resampled = df_combined_resampled.loc[start:start]
    ...
    df_combined_resampled.at[start, 'predicted_temperature'] = predicted_temperature
    df_combined_resampled.at[start, 'predicted_valve_level'] = predicted_valve_level
